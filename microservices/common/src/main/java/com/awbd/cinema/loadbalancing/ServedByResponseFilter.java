 ...
 *
 * <p>Registered as a bean by {@link LoadBalancingConfig} (not component-scanned), so it is not
 * pulled into {@code @WebMvcTest} slices without its {@link InstanceInfo} dependency.
 */
